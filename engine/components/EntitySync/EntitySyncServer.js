define(['engine/components/EntitySync/EntitySyncBase', 'engine/core/Exception', 'underscore'], function(EntitySyncBase, Exception, _) {
        var EntitySyncServer = EntitySyncBase.extend({
            _classId: 'EntitySyncServer',
            ...
            update: function() {
                if(false === EntitySyncBase.prototype.update.call(this)) {
                    return false;
                }
